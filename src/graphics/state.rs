...
impl State {
    ...
    pub async fn new(window: Window) -> Self {
        ...
        let diffuse_texture = Texture::from_bytes(&device, &queue, include_bytes!("happy-tree.png"), "happy-tree.png").unwrap();
        ...
        let shader = device.create_shader_module(wgpu::include_wgsl!("shader/draw.wgsl"));
